...
const config = {
    serverInfo: {
        ...
        serverName: "Raspberry MC", /*Server name*/
        serverIp: "mc.raspberry.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
    ...
    */
    contactPage: {
        email: "senalthusaraka15@gmail.com"
    }
}
